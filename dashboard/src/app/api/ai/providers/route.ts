...
import {
  getDiscoveredHostGatewayOrigin,
  getOllamaCandidateOrigins,
  getOllamaServerOrigin,
} from '@/lib/ai/ollamaServerUrl';
  ...
  try {
    ...
    const config = {
      ...
      environment: {
        ...
        ollamaDiscoveredHostGateway: getDiscoveredHostGatewayOrigin(),
